...
<div class="container mt-3">
    <?php if(isset($error['checkAlready'])):?>
        <h2 class="text-center text-danger"><?=$error['checkAlready']?></h2>
    <?php endif ?>
<form method="POST">
    <div class="row">
        <div class="col">
    ...
    <div class="row mt-2">
        ...
        <div class="col-3">
            ...
            <input type="text" class="form-control border border-dark rounded-pill" placeholder="Nhập vào năm phát hành phim" aria-label="year_release" id="year_release" name="year_release">
